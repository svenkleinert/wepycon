from . import QDialog, QComboBox, QLabel, QHBoxLayout, QVBoxLayout, QPushButton, QGroupBox, Slot, QRadioButton
        ...
        if self.group_box_vbox.count() > 0:
            ...
            for i in range( self.group_box_vbox.count() ):
                if self.group_box_vbox.itemAt(i).widget().isChecked():
                    return camera_types[_type].from_device_number(i)
        return None
